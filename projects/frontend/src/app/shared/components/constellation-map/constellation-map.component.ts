...
export class ConstellationMapComponent {
  ...
  readonly satelliteNodes: ConstellationNodeConfig[] = [
    ...
    { label: 'Orbit', route: '/today', angle: 51, accent: 'teal' },
    { label: 'Streak', route: '/sky', angle: 102, accent: 'gold' },
    { label: 'Constellations', route: '/constellations', angle: 153, accent: 'violet' },
    { label: 'Reflection', route: '/reflection', angle: 207, accent: 'teal' },
    { label: 'Activity', route: '/sky', angle: 258, accent: 'aurora' },
    { label: 'Progress', route: '/sky', angle: 309, accent: 'gold' }
  ];
}
